$( document ).ready(function() {
   ...
   $('#age-data').on('click', function(){
    ...
    $('#age-data-vaccinations-tab').click(function(){
        $('#display-iframe').attr('src', './chart_htmls/age_vax.html');
    ...
    $('#vaccination-data-cdc-cumulative-tab').click(function(){
        $('#display-iframe').attr('src', './chart_htmls/cdc_vaccinations.html');
